                ...
                <div class="main-content container-fluid" id="#Apresentacao"> <!-- Begin main-content -->
                    <div class="row"> <!-- Begin row -->
                        ...
                        <div class="col-md-10"> <!-- Begin col-md-10 -->
                            ...
                            <br><p>Para cadastrar o organograma do órgão, deverá ser encaminhado à Coordenadoria de Gestão Patrimonial e Recursos Logísticos - Copat/Seplag um "Processo Administrativo" protocolado no Viproc instruído com: </p>

                            <ol> 
                                <li class="wow fadeInRight" data-wow-delay="1.0s">Ofício do titular do órgão;</li>
                                <li class="wow fadeInRight" data-wow-delay="1.3s">Decreto de criação do órgão; </li>
                                <li class="wow fadeInRight" data-wow-delay="1.6s">Organograma.</li>
                            </ol>

                            <br><p>Toda alteração na estrutura deverá ser previamente informada por intermédio de processo administrativo. Para orientações adicionais sobre a criação de setores no SIGA/SGBM contactar o atendimento operacional pelos telefones (85) 3101-7801, (85)3 101-7816, (85) 3101-3829 ou e-mail atendimento@seplag.ce.gov.br.</p>
