                ...
                <div class="row"> <!-- Begin row -->
                    ...
                    <div class="col-md-10"> <!-- Begin col-md-10 -->
                        <div class="page-title">
                            ...
                            <!-- Sub Título -->
                            <p class="SubTitulo"> Alterar Classificação de Item de Material Permanente </p>
                            <hr>
                            ...
                            <ol>
                                ...
                                <br><!-- Titulo Figura -->
                                <div class="text-center">
                                    <a href="imagens/Figura159.png" data-bs-toggle="modal" data-bs-target="#Imagem159">
                                        <img class="img-fluid wow fadeInRight" data-wow-delay="0.5s" src="imagens/Figura159.png" alt="Alt da imagem fica aqui">
                                    </a>
                                </div>

                                <!-- Imagem 159 - MODAL -->
                                <div class="modal fade text-center" id="Imagem159" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-body">
                                ...
                                <br><!-- Titulo Figura -->
                                <div class="text-center">
                                    <a href="imagens/Figura160.png" data-bs-toggle="modal" data-bs-target="#Imagem160">
                                        <img class="img-fluid wow fadeInLeft" data-wow-delay="0.5s" src="imagens/Figura160.png" alt="Alt da imagem fica aqui">
                                    </a>
                                </div>

                                <!-- Imagem 160 - MODAL -->
                                <div class="modal fade text-center" id="Imagem160" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-body">
