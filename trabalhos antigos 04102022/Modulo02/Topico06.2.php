                ...
                <div class="row"> <!-- Begin row -->
                    ...
                    <div class="col-md-10"> <!-- Begin col-md-10 -->
                        <div class="page-title">
                            ...
                            <p>O controle por intermédio do “Fechamento Mensal”, ao delimitar um determinado período de tempo, permite estabelecer parâmetros para dimensionar as quantidades adequadas que cada material deve permanecer em estoque para atender às necessidades sem quebra de continuidade no suprimento. Com o “fechamento mensal” o SIGA/SGBM equacionará os estoques existentes, com relação às aquisições e ao consumo dentro de um período de tempo, possibilitando identificar o excesso ou a insuficiência de suprimento dos materiais. Alguns relatórios gerenciais do SIGA/SGBM somente poderão ser emitidos após a realização do “fechamento mensal”.Para efetuar o Fechamento Mensal o perfil "Almoxarife" deverá selecionar na barra de menu do SIGA/SGBM o comando: “Processos”, “Almoxarifado”, “Fechamento Almoxarifado”.</p>
                            <br>
                            <ol>                            
                                <br><br><!-- Titulo Figura -->
                                ...
                                <!-- Imagem 274 - End --><br>
                                <p>É aconselhável que o fechamento mensal seja efetuado no 1º dia útil do mês seguinte, devido a necessidade de conferir e consolidar às movimentações antes de fechar o mês. Enquanto o mês anterior não for fechado as movimentações do mês corrente ficam travadas e após o fechamento não poderão ser efetuados cancelamentos de movimentações efetuadas com erro de registro. Ao acionar o referido comando o SIGA/SGBM apresentará a grade "Meses pendentes" contendo na sequência crescente os meses que encontram-se em aberto no sistema.</p>                               
                                <br>
                                <li class="wow fadeInLeft" data-wow-delay="0.3s">Na coluna "Ações" clicar no ícone azul em formato de agenda para agendar o Fechamento do Mês. O sistema programará um horário para que sejam executados os programas de cálculo dos valores das movimentações do período  e apuração do saldo final.</li>
                                <br>
                                <!-- Titulo Figura -->
                                <div class="text-center">
