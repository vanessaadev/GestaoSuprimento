                ...
                <div class="row"> <!-- Begin row -->
                    ...
                    <div class="col-md-10"> <!-- Begin col-md-10 -->
                        <div class="page-title">
                            ...
                            <br><p><strong>Objetivo:</strong> Compreender o processo de levantamento, depuração e tratamento de dados a serem alimentados no SIGA/SGBM de forma a implantar o sistema de forma consistente e conciliado com o sistema contábil. </p>
