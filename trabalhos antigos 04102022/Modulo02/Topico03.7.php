                ...
                <div class="row"> <!-- Begin row -->
                    ...
                    <div class="col-md-10"> <!-- Begin col-md-10 -->
                        <div class="page-title">
                            ...
                            <p>O cadastramento dos itens na  deverá ser efetuado pelo perfil "Almoxarife" ou "Almoxarife/Gestor Patrimonial" utilizando o comando <strong>MANUTENÇÃO >> Almoxarifado >> Material >> Cadastro</strong>.</p>
