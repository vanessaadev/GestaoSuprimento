                ...
                <div class="row"> <!-- Begin row -->
                    ...
                    <div class="col-md-10"> <!-- Begin col-md-10 -->
                        <div class="page-title">
                            ...
                            <ol>
                                <li class="wow fadeInLeft" data-wow-delay="0.3s">Ao acionar o comando na barra de menu o SIGA/SGBM inicia a consulta no acervo de itens cadastrados no sistema. Para efetuar a consulta são necessários alguns filtros, o quanto mais forem utilizados, mais restrita será a consulta. No campo "Grupo" selecionar o grupo de classificação dos itens que se deseja inserir como parâmetro na consulta.</li>
                                <li class="wow fadeInLeft" data-wow-delay="0.6s">À medida que for selecionado um "Grupo" específico o SIGA/SGBM direciona os parâmetros para àquelas classes correspondentes ao “Grupo” selecionado. Então no campo "Classe" selecionar a classe de material que se deseja inserir como parâmetro na consulta.</li>
                                <li class="wow fadeInLeft" data-wow-delay="0.9s"> No campo "Tipo de Material" selecionar como mais um parâmetro o tipo de material que se deseja visualizar na consulta</li>
                                <li class="wow fadeInLeft" data-wow-delay="1.3s">No campo "Status" selecionar como mais um parâmetro da consulta à condição de uso do material se "Ativo" ou "Inativo".</li>
                                <li class="wow fadeInLeft" data-wow-delay="1.6s">Acionar o botão "Pesquisar" para montar a consulta.</li>
                                <br>
                                ...
                                <li class="wow fadeInLeft" data-wow-delay="0.9s"> Na coluna "Ações" no ícone azul em formato de "Botão" se acionado será inativa do ou ativado o item de material.</li>
                                ...
                                <li class="wow fadeInLeft" data-wow-delay="1.6s">No rodapé da grade no lado direito, será apresentada botões de navegação entre as páginas existentes na consulta. Cada página da consulta apresentará no mínimo 10 itens compondo a grade.</li>
                                <br>   
                                <br><br><!-- Titulo Figura -->
                                <div class="text-center">
                                ...
                                <li class="wow fadeInLeft" data-wow-delay="0.6s">Em seguida acionar o botão "Pesquisar" para finalizar a consulta.</li>
                                <br><br><!-- Titulo Figura -->
                                <div class="text-center">
                                ...
                                <!-- Imagem 224 - End -->
                                <br>
                                <li class="wow fadeInLeft" data-wow-delay="1.6s">Acionado o botão "Pesquisar" a consulta será apresentado no mesmo formato visto nos itens 6 a 10 anteriores, sendo que por se tratar de uma consulta individualizada por código será apresentado somente um item.</li>
                                <br>   
                                <br><br><!-- Titulo Figura -->
                                <div class="text-center">
