                ...
                <div class="row"> <!-- Begin row -->
                    ...
                    <div class="col-md-10"> <!-- Begin col-md-10 -->
                        <div class="page-title">
                            ...
                            <br>
                            <li class="wow fadeInLeft" data-wow-delay="1.6s">No campo “Valor Médio Inicial” informar quanto custa em moeda a unidade do item. No exemplo abaixo será o valor da "Caixa" dividido por 100 (doze). Este campo somente será editado quando da implantação do item ou quando o item estiver com saldo Zero, por isso o adjetivo "inicial". Enquanto o item estiver saldo em movimentação o valor unitário do item será calculado pela média, ou seja, o valor do estoque mais o valor das entradas dividido pelo saldo em quantidade existente após registrada a entrada.</li>                            
                            <li class="wow fadeInLeft" data-wow-delay="2.3s">No campo "Unidade de consumo" informar a unidade na qual o item de material vai ser entregue ao requisitante.  No exemplo abaixo o material será entregue em Unidade, mesmo sendo adquirido em Caixa. Quando a unidade de entrega for igual a unidade de fornecimento deverá ser informado como "Unidade de Consumo" também "Caixa".</li>
