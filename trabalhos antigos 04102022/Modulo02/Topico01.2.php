                    ...
                    <div class="row"> <!-- Begin row -->
                        ...
                        <div class="col-md-10"> <!-- Begin col-md-10 -->
                            <div class="page-title Texto">
                                ...
                                <br><table class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <br><br>Caso não estejam cadastrados, proceder o cadastramento, por intermédio do SIGA/SGBM, seguindo as orientações da Coordenadoria de Gestão Estratégica de Compras – Cogec da Seplag. A solicitação de inclusão no “Catálogo” deverá ser feita por intermédio do SIGA/SGBM.   </td>
                                        </tr>
                                        <tr>
                                ...
                                <br><table class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <br><br>Ao finalizar o registro dos saldos, emitir o Relatório Resultado da Migração com o valor contábil ajustado para todos os bens móveis do acervo patrimonial do órgão/entidade.  </td>
                                        </tr>
                                        <tr>
                                ...
                                <br><p>A terceira etapa caracteriza-se pelo cadastramento e acesso dos requisitantes e a capacitação dos demais usuários envolvidos na gestão de estoque e gestão patrimonial.</p>
