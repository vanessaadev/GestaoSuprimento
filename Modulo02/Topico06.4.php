            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <div class="page-title">
                        ...
                        <p>Para emissão dos relatórios do Siga/Sgbm no módulo de estoque o perfil "Almoxarife" deverá acionar na barra de menu o comando: “Relatórios, Almoxarifado”. </p>
                        ...
                        <p>Periodicidade: Eventual. <br>Parâmetros de Emissão:</p>
                        <ol>
                        ...
                        <ol>
                            ...
                            <li class="wow fadeInRight" data-wow-delay="0.3s">No campo "Data Inicial" informar a data de início do período a ser inclusão no relatório.</li>
                            <li class="wow fadeInRight" data-wow-delay="0.6s">No campo "Data Limite" informar a data que delimita o período a ser inclusão no relatório.</li>
                            <li class="wow fadeInRight" data-wow-delay="0.9s">Abaixo das duas datas que compreendem o período é habilitado o botão "Adicionar" que acionado irá formando abaixo uma grade com a série de períodos para apuração do comportamento do consumo.</li>
                            <li class="wow fadeInRight" data-wow-delay="1.3s">No campo tipo de material selecionar a opção "Consumo".</li>
                            <li class="wow fadeInRight" data-wow-delay="1.6s">A cada período adicionado a grade irá aumentando o número de linhas.</li>
                            ...
                            <li class="wow fadeInRight" data-wow-delay="2.3s">Acionar o botão "Gerar Relatório" para emissão do relatório em formato PDF.</li>
                        ...
                        <ol>
                            <li class="wow fadeInRight" data-wow-delay="0.3s"> No campo "Tipo de Material" selecionar a opção "CONSUMO".</li>
                            <li class="wow fadeInRight" data-wow-delay="0.6s">No campo "Setor" selecionar qual a abrangência a ser dada no relatório: se deve considerar todos os setores ou um setor específico , caso seja "apenas um" setor o SIGA/SGBM apresentará uma caixa de seleção para que seja escolhido o setor de referência para emissão do relatório, caso contrário não informar esse campo e o relatório será gerado para todos os setores.</li>
                            <li class="wow fadeInRight" data-wow-delay="0.9s"> No campo "Ano" informar o ano de movimentação que se deseja apurar.</li>
                            <li class="wow fadeInRight" data-wow-delay="1.3s"> No campo "MÊS" informar o mês de movimentação que se deseja apurar.</li>
                            <li class="wow fadeInRight" data-wow-delay="1.6s"> Acionar o botão "Gerar Relatório" para emissão do relatório em formato PDF.</li>
                            <br>
                            <!-- Fique Atento -->
                            <div class="FiqueAtentoCaixa">
                                <p class="FiqueAtentoTitulo"> Fique Atento</p>
                                <div class="FiqueAtentoTexto">
                                    <p>Caso a emissão do relatório seja para um item específico na "grade de filtro" informar o item pelo código ou palavra chave.</p>
                                </div>
                            </div>
                            <br>
                        ...
                        <ol>
                            <li class="wow fadeInRight" data-wow-delay="0.3s">No campo "Tipo de Material" informar a opção "CONSUMO".</li>
                            <li class="wow fadeInRight" data-wow-delay="0.6s"> No campo "Ano" informar o o Ano de referência para a emissão do relatório.</li>
                            <li class="wow fadeInRight" data-wow-delay="0.9s">No campo "MÊS" informar o mês de referência para a emissão do relatório.</li>
                            <li class="wow fadeInRight" data-wow-delay="1.3s">Acionar o botão "Gerar Relatório" para emissão do relatório em formato PDF.</li>
                        ...
                        <ol>
                            ...
                            <li class="wow fadeInRight" data-wow-delay="0.3s">No campo "Período de Movimentação" informar a Data Inicial e a Data Final que delimita o período de referência do relatório.</li>
                            <li class="wow fadeInRight" data-wow-delay="0.6s"> No campo "Tipo de Entrada" selecionar qual a modalidade de entrada que poderão ser:</li>
                            <ul>
                            ...
                            <li class="wow fadeInRight" data-wow-delay="2.3s">No campo "Tipo de Material" selecionar a opção referente ao tipo de Material a que se refere a entrada se CONSUMO ou PERMANENTE.</li>
                            <li class="wow fadeInRight" data-wow-delay="2.6s">No campo "Filtrar por um fornecedor apenas" informar a "Razão Social" ou "CNPJ" do fornecedor. é recomendável que seja informado o CNPJ por que a busca será específica por se tratar de uma pesquisa numérica no caso de Razão Social será uma busca alfabética e poderá ser usada qualquer palavra que conste na composição da Razão Social do Fornecedor e poderá ser demonstrado um fornecedor que não seja o desejado.</li>
                            <li class="wow fadeInRight" data-wow-delay="2.9s">Acionar o botão "Adicionar" para incluir o fornecedor nos parâmetros do relatório</li>
                            <br>
                            <!-- Titulo Figura -->
                            <div class="text-center">
                            ...
                            <!-- Imagem 347 - End -->
                            <br>
                            <li class="wow fadeInRight" data-wow-delay="0.3s">Uma vez acionado o botão "Adicionar" o Siga/Sgbm demonstra a "Razão Social" e o "Nome Fantasia" do fornecedor para que seja confirmado. Vale ressaltar que se não for o fornecedor desejado bata acionar o botão "Alterar".</li>
                            <li class="wow fadeInRight" data-wow-delay="0.3s"> Acionar o botão "Gerar Relatório" impressão do relatório em formato "PDF".</li>
                            <br>
                        ...
                        <ol>
                            ...
                            <li class="wow fadeInRight" data-wow-delay="0.3s"> Selecionar o ano de referência para a emissão do relatório.</li>
                            <li class="wow fadeInRight" data-wow-delay="0.6s"> Selecionar o mês de referência para a emissão do relatório</li>
                            <li class="wow fadeInRight" data-wow-delay="0.9s"> Selecionar a modalidade de apresentação do relatório se deverão ser listados todos os itens em sequência alfabética de descrição ou se deverão ser listados agrupados por categoria segundo a classificação do Catálogo de Bens Materiais e Serviços.</li>
                            <li class="wow fadeInRight" data-wow-delay="1.3s"> Acionar o botão "Gerar Relatório" para emissão do relatório em formato PDF.</li>
                        ...
                        <ol>
                            <br>
                            <li class="wow fadeInRight" data-wow-delay="0.3s"> No campo "Período Movimentação" informar a "Data Inicial" e a "Data Final" que compôs o referido período.</li>
                            <li class="wow fadeInRight" data-wow-delay="0.6s">Selecionar o tipo de movimento que não ocorreu durante o período de análise do relatório se somente o movimento de "Entrada" ou somente o movimento de "Saída" ou se não houve nenhuma movimentação.</li>
                            <li class="wow fadeInRight" data-wow-delay="0.9s"> Acionar o botão "Gerar Relatório" para emissão do relatório em formato PDF.</li>
                            <br>
                            <!-- Titulo Figura -->
                            <div class="text-center">
                        ...
                        <ol>
                            <br>
                            <li class="wow fadeInRight" data-wow-delay="0.3s"> No campo "Tipo de Material" selecionar qual a opção de item a ser relacionado se itens de patrimônio ou itens de material de consumo.</li>
                            <li class="wow fadeInRight" data-wow-delay="0.6s">No campo "Ordenado por" selecionar se a ordem de seqüencial do relatório será por ordem de código ou por ordem alfabética.</li>
                            <li class="wow fadeInRight" data-wow-delay="0.9s"> Acionar o botão "Gerar Relatório" para emissão do relatório em formato PDF.</li>
                            <br>
                            <!-- Titulo Figura -->
                            <div class="text-center">
                        ...
                        <ol>
                            <br>
                            <li class="wow fadeInRight" data-wow-delay="0.3s"> No campo "Tipo de Material" selecionar a opção correspondente ao tipo de material em estoque se "CONSUMO" ou "PATRIMÔNIO".</li>
                            <li class="wow fadeInRight" data-wow-delay="0.6s">No campo "Posição Estoque" selecionar a opção correspondente à posição de estoque que se deseja demonstrar no relatório se "Material em Estoque", "Material sem Estoque" ou "Baseado em Data". Nesta última opção o Siga/Sgbm acrescentará dois novos campos a serem informados "Ano" e "MÊS" </li>
                            <li class="wow fadeInRight" data-wow-delay="0.9s"> Acionar o botão "Gerar Relatório" para emissão do relatório em formato PDF.</li>
                            <br>
                            <!-- Titulo Figura -->
                            <div class="text-center">
                        ...
                        <ol>
                            <br>
                            <li class="wow fadeInRight" data-wow-delay="0.3s">No campo "Período de Movimentação" informar a data inicial e a data final que delimita o período de referência do relatório.</li>
                            <li class="wow fadeInRight" data-wow-delay="0.6s"> No campo "Tipo de Material" selecionar a opção de material entre CONSUMO e PATRIMÔNIO.</li>
                            <li class="wow fadeInRight" data-wow-delay="0.9s"> No campo "Emissão" selecionar a forma de apresentação da movimentação se "POR QUANTIDADE" ou "POR CUSTO".</li>
                            <li class="wow fadeInRight" data-wow-delay="0.3s">Na grade "Filtrar por um material apenas" selecionar a opção de identificação do material objeto do relatório. Nos casos de não preenchimento desses campos será emitido o relatório para todos os itens de estoque.</li>
                            <li class="wow fadeInRight" data-wow-delay="0.6s"> Na mesma grade "Filtrar por um material apenas" informar na caixa de texto o código ou a palavra chave usada para pesquisa do material em seguida acionar o botão "Pesquisar".</li>
                            <br>
                            <!-- Titulo Figura -->
                            <div class="text-center">
                            ...
                            <li class="wow fadeInRight" data-wow-delay="0.3s">Acionar o botão "Gerar Relatório" para a emissão do relatório segundo os parâmetros informados.</li>
                            <br>
                            <!-- Titulo Figura -->
                            <div class="text-center">
