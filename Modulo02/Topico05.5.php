                    ...
                    <div class="col-md-10"> <!-- Begin col-md-10 -->
                        <div class="page-title">
                            ...
                            <ol>
                                ...
                                <li class="wow fadeInLeft" data-wow-delay="1.3s">Acionar o Botão “Editar” para edição da solicitação. Caso a COGEC/SEPLAG encaminhar alguma orientação, o almoxarife poderá refazer a solicitação clicando nesse botão.</li>
                                <li class="wow fadeInLeft" data-wow-delay="1.6s">Acionar o Botão “Novo” para fazer outra solicitação na sequência.</li>
                                <br>   
                                <br><br><!-- Titulo Figura -->
                                <div class="text-center">
