                ...
                <div class="main-content container-fluid" id="#Apresentacao"> <!-- Begin main-content -->
                    <div class="row"> <!-- Begin row -->
                        ...
                        <div class="col-md-10"> <!-- Begin col-md-10 -->
                            ...
                            <br><br>O sistema foi desenvolvido no ambiente INTERNET, permitindo o acesso por intermédio de senhas individualizadas, mantendo a integridade dos dados de cada órgão e entidade e possibilitando também a consolidação de informações de consumo de materiais e movimentações de bens entre os órgãos que utilizam o sistema. </p>

                            <br><!-- Sub Título -->
                            <p class="SubTitulo">As Características e Integração do Sistema</p>
                            <hr>

                            <br><p>Para obter a padronização o SIGA/SGBM se integra com outros sistemas corporativos do Governo Estadual, tais como:</p>
                            ...
                            <div class="accordion accordion-flush" id="AccordionFase01">
                                ...
                                <br><br><p>Em função das características de integração com outros sistemas corporativos do Governo do Estado, o SIGA/SGBM terá uma estratégia específica de implantação exigindo o cumprimento de etapas e adoção de procedimentos pré-estabelecidos.</p>
