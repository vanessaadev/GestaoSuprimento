                ...
                <div class="row"> <!-- Begin row -->
                    ...
                    <div class="col-md-10"> <!-- Begin col-md-10 -->
                        <div class="page-title">
                            ...
                            <p>Ao identificar, na ocasião As Notas Fiscais de entrada para serem canceladas pelo SIGA/SGBM necessitam ser autorizadas pelo perfil "Gestor Financeiro" que para efetuar a operação deve acionar na barra de menu do SIGA/SGBM o comando <strong>"Movimentos, Almoxarifado, Entrada, Autorização de Cancelamento"</strong> </p>
                            ...
                            <ol>
                                <li class="wow fadeInLeft" data-wow-delay="0.3s">Ao acionar o comando na barra de menu o SIGA/SGBM apresentará uma grade com as "Entradas encontradas no período" demonstrando as seguintes informações referentes ao cancelamento da Nota Fiscal de entrada: Fornecedor emitente da Nota Fiscal, Não da Nota Fiscal, Data da solicitação de cancelamento, Almoxarife que registrou a entrada na Nota Fiscal, Almoxarife que solicitou o cancelamento e a Justificativa para o cancelamento da Nota". Após analisar as informações e averiguar com o almoxarife solicitante o cancelamento poderá aprovar ou não o cancelamento. </li>
                                <li class="wow fadeInLeft" data-wow-delay="0.6s">Acionar o ícone em formato de "Lupa" para consultar o conteúdo da Nota Fiscal. </li>
                                <li class="wow fadeInLeft" data-wow-delay="0.9s">Acionar o ícone em formato de "Check" para aprovar o cancelamento. </li>
                                <li class="wow fadeInLeft" data-wow-delay="1.3s">Para reprovar o cancelamento clicar no ícone vermelho em formato de "X".</li>
                                ...
                                <li class="wow fadeInLeft" data-wow-delay="0.3s">Acionado o ícone de aprovação o SIGA/SGBM apresentará uma janela de confirmação da operação e para confirmar basta acionar o botão "OK".</li>
