                        ...
                        <div class="page-title">
                            ...
                            <br>
                                ...
                                <div class="FiqueAtentoCaixa">
                                    ...
                                    <p class="FiqueAtentoTexto"> Vale ressaltar, que para efetuar um cancelamento de Nota Fiscal, o SIGA/SGBM estabelece algumas condicionantes: </p>

                                    <ol>
                                        <li class="wow fadeInLeft" data-wow-delay="0.3s">A nota fiscal em questão ter sido registrada no período corrente. </li>
                                        <li class="wow fadeInLeft" data-wow-delay="0.6s">Não ter havido nenhum atendimento de REQUISIÇÃO dos itens constantes na Nota Fiscal. </li>
                                        <li class="wow fadeInLeft" data-wow-delay="0.9s">Apár solicitado o cancelamento, o SIGA bloqueará as Requisiáres dos itens que constam na Nota e as Requisiáres não atendidas, atáro momento, somente poderão ser atendidas com quantidade Zero. </li>
                                        <li class="wow fadeInLeft" data-wow-delay="1.3s">Enquanto não for autorizado o Cancelamento, o Fechamento Mensal será bloqueado. A autorização será  dada pelo "perfil Gestor Financeiro".</li>
                                    </ol>
                                </div><br>
                                ...
                                <ol>
                                    <li class="wow fadeInLeft" data-wow-delay="0.3s">No campo "Período de Movimentação" informar as datas inicial e final delimitando o período em que a Nota Fiscal deu entrada.</li>
                                    <li class="wow fadeInLeft" data-wow-delay="0.6s">No campo "Status da Nota" clicar na seta ao lado do campo e selecionar a condição "FINALIZADA".</li>
                                    <li class="wow fadeInLeft" data-wow-delay="0.9s">No campo "Nota Fiscal" informar o número da Nota Fiscal que se deseja consultar.</li>
                                    <li class="wow fadeInLeft" data-wow-delay="1.3s">No campo "Número de Série" informar a série da Nota Fiscal que se deseja consultar.</li>
                                    <li class="wow fadeInLeft" data-wow-delay="1.6s">Acionar o botão "Pesquisar" para trazer a Nota Fiscal em questão.</li> 
                                    ...
                                    <li class="wow fadeInLeft" data-wow-delay="0.3s">Ao acionar o botão "Pesquisar" o SIGA/SGBM apresentará uma "grade" contendo os seguintes dados das Notas Fiscais filtradas a partir dos parâme tros informados: Data da Nota Fiscal, Fornecedor, Nár da Nota Fiscal, Série da Nota Fiscal, Status da Nota Fiscal e Aáres.</li>
                                    <li class="wow fadeInLeft" data-wow-delay="0.6s">A partir dos dados apresentados da "grade" poderá ser selecionada o ícone em formato de "Seta de Retorno" para que seja efetuado a solicitação de cancelamento.</li>
