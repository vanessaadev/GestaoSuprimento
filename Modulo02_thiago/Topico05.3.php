                ...
                <div class="row"> <!-- Begin row -->
                    ...
                    <div class="col-md-10"> <!-- Begin col-md-10 -->
                        <div class="page-title">
                            ...
                            <p>O SIGA/SGBM permite efetuar a baixa de material decorrente de inutilidade para consumo, tais como: deterioração, obsolescência, validade vencida, entre outras situações. Para baixar um item o perfil "Almoxarife" deverá acionar na barra de menu o comando: "Movimentos, Almoxarifado, Baixa".</p>
                            ...
                            <ol>
                                <li class="wow fadeInLeft" data-wow-delay="0.3s">Acionado o comando na barra de menu o SIGA/SGBM apresentará a janela de baixa. No campo "Justificativa" descrever uma observação das razões que levaram à baixa do material, tais como: deterioração, inutilidade, validade vencida, obsolescência entre outras.</li>
                                <li class="wow fadeInLeft" data-wow-delay="0.3s">Na janela "Pesquisa Produto" selecionar a forma com que o item a ser baixado será identificado, ou seja, por código ou palavra chave. Nesse caso de baixa é recomendável utilizar o código uma vez que o material é item de estoque e o código é acessível. Também pode ser selecionado o tipo de material se consumo ou patrimônio.</li>
                                <li class="wow fadeInLeft" data-wow-delay="0.3s">Na caixa de texto informar o número do código.</li>
                                <li class="wow fadeInLeft" data-wow-delay="0.3s">Para identificar o item a ser baixado acionar o botão "Pesquisa".</li><br>
                                ...
                                <li class="wow fadeInLeft" data-wow-delay="0.3s">Ao acionar o botão "Pesquisar" o SIGA/SGBM apresenta a janela de "Materiais Encontrados" como a pesquisa foi efetuada por "Código" será apresentado somente um item nessa janela e já virá marcado o  quadrículo formado na primeira coluna da grade. Quando a "pesquisa do produto" for por "palavra chave" aparecerão mais de um produto, então será necessário marcar o quadrículo correspondente.</li>
                                <li class="wow fadeInLeft" data-wow-delay="0.6s">No campo quantidade digitar a quantidade que será baixada do item considerando quatro casas decimais. Essa quantidade deverá ser inferior a quantidade em estoque do item mostrada na 5ª coluna da grade.</li>
                                <li class="wow fadeInLeft" data-wow-delay="0.9s">Para finalizar a seleção acionar o botão "Adicionar".</li>
                                ...
                                <li class="wow fadeInLeft" data-wow-delay="0.6s">Também na coluna "Ações" no final da grade, é apresentado um ícone na cor vermelha em formato de "X" que quando acionado dele ta da grade o item anteriormente selecionado.</li>
                                ...
                                <!-- Imagem 217 - End --><br>
                                <li class="wow fadeInLeft" data-wow-delay="0.3s">Ao finalizar a operação o SIGA/SGBM apresenta uma mensagem de confirmação, em seguida clicar o botão "OK".</li>
                                <br>
                                <br><!-- Titulo Figura -->
                                <div class="text-center">
                                ...
                                <li class="wow fadeInLeft" data-wow-delay="0.6s">Ao finalizar a operação o SIGA/SGBM apresenta a tela de "Baixa" e acionando o botão "Imprimir" é gerado o "Relatório de Baixa".</li>
                                <br>
                                <br><!-- Titulo Figura -->
                                <div class="text-center">
