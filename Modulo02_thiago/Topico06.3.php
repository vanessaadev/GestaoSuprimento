                ...
                <div class="row"> <!-- Begin row -->
                    ...
                    <div class="col-md-10"> <!-- Begin col-md-10 -->
                        <div class="page-title">
                            ...
                            <p>A ferramenta de apoio ao inventário de estoque, disponível no SIGA/SGBM, baseia-se no inventário com contagens cegas, ou seja, conta-se primeiro o físico e depois confronta-se a contagem com o registro escritural para verificar se houve divergência. Para que não haja erro na contagem, o sistema só considera a contagem válida quando houver mais de uma contagem coincidente. Isso implica que haverá no mínimo duas contagens para cada item inventariado. </p>
                            ...
                            <p>A ferramenta de apoio ao inventário disponível no SIGA dará apoio a três modalidades de inventário, a saber:
                            </p>
                            <p>1) Inventário Geral: Trata-se do inventário de todos os itens de materiais existentes em estoque, essa modalidade de inventário será utilizada nos inventários de final de exercício contábil, ou seja, anualmente, ou então quando se fizer necessário por questões de controle interno do órgão/entidade.</p>
                            <p>2) Inventário por Grupo: Trata-se do inventário dos itens de materiais pertencentes a uma determinada classe de materiais, essa modalidade de inventário será utilizada para os órgãos que desejem efetuar o inventário permanente, efetuando contagens periodicamente por grupos de materiais. </p>
                            <p>3) Inventário Específico: Trata-se do inventário de itens escolhidos pelo gestor do almoxarifado, será utilizado nos inventários de acerto ou para itens de alta rotatividade que necessitam ser inventariados sistematicamente.</p>
                            <p>Para garantir maior controle na realização do inventário, a ferramenta de apoio ao inventário de estoque, disponível no SIGA/SGBM, fará o cadastro das equipes inventariantes. A medida que o inventário é criado, segundo o seu tipo, paralelamente poderão ser cadastradas as pessoas que participarão  do inventário, atribuindo a cada contagem um grupo de pessoas que a executará, é prudente que sejam cadastradas um número de pessoas suficiente para formar equipes  para realizar a contagem dentro do prazo planejado para realizar o inventário.</p>
                            ...
                            <p>Acionado o comando na barra de menu, o SIGA/SGBM demonstra um painel de gerenciamento de inventário composta por: um "mecanismo de identificação e localização de inventários", uma "agenda de execução de inventários" e um mecanismo de "criação e localização de participantes".  A descrição desses controles é apresentada a seguir</p>

                            <ol>
                                <li class="wow fadeInRight"  data-wow-delay="0.3s">No campo “Descrição”, descreva o nome ou parte do nome de um inventário. Esse campo serão preenchido para localizar um inventário dentre àqueles já realizados ou em andamento ou então para criar um novo inventário.</li>
                                <li class="wow fadeInRight"  data-wow-delay="0.6s">Acionar o botão “Pesquisar”, para localizar um inventário cujo nome ou parte do nome de um inventário foi descrito no campo 01 anterior (Descrição). </li>
                                <li class="wow fadeInRight"  data-wow-delay="0.9s">Acionar o botão “Limpar”, para tornar vazia a grade "Inventários Cadastrados". </li>                                    
                                <li class="wow fadeInRight"  data-wow-delay="1.3s">Acionar o botão “Criar Inventário”, para criar um inventário novo a partir do preenchimento do campo 01 anterior (Descrição).</li>
                                <li class="wow fadeInRight"  data-wow-delay="1.6s">Grade "Inventários Cadastrados" que demonstra dados sobre inventários realizados assim como permite a execução de uma agenda de controle de um inventário a partir dos ícones localizados na coluna "Ações".</li>
                                ...
                                <li class="wow fadeInRight"  data-wow-delay="2.9s">Acionar o botão "Cadastrar" para gravar o nome e CPF preenchido nos campos 08 e 09 respectivamente.</li>
                                <li class="wow fadeInRight"  data-wow-delay="3.3s">Grade "Pessoas cadastradas neste almoxarifado" que permite o gerenciamento de pessoas que participará  de inventários.</li>    
                            ...
                            <ol>
                                ...
                                <li class="wow fadeInRight"  data-wow-delay="0.6s"> Ao clicar no botão "Criar Inventário" o Siga/Sgbm demonstrará o Almoxarifado em que será criado o inventário, a data de abertura pedirá  que seja definido qual o "tipo de inventário" a ser realizado, se do tipo GERAL, ESPECÍFICO ou GRUPO. Dependendo da escolha o Siga/Sgbm habilitará campos correspondentes ao tipo de inventário escolhido.</li>
                                ...
                                <li class="wow fadeInRight"  data-wow-delay="0.3s">No campo "Descrição" descrever o nome do inventário identificando o tipo de inventário e o mês e ano de realização.</li>
                                <li class="wow fadeInRight"  data-wow-delay="0.6s">No campo "Tipo de Inventário" selecionar a opção  ESPECÍFICO, nessa opção o SIGA/SGBM habilitará o botão “Pesquisar produtos” para que sejam selecionados os itens específicos que farão parte do inventário. </li>
                                <li class="wow fadeInRight"  data-wow-delay="0.9s">Acionar o botão "Pesquisar produtos" para selecionar os itens que farão parte do inventário.</li>
                                ...
                                <!-- Imagem 281 - End --><br>
                                <p>Ao acionar o botão "Pesquisar produtos" o Siga/Sgbm demonstrará uma janela "pop up" com os campos de seleção dos itens.</p>

                                <li class="wow fadeInRight"  data-wow-delay="0.3s">No campo "Palavra chave" descrever uma palavra que fará parte da especificação do item e que possibilite a individualização do mesmo. Ou:</li>
                                <li class="wow fadeInRight"  data-wow-delay="0.6s">No campo "Código" descrever o código de individualização do item.</li>
                                <li class="wow fadeInRight"  data-wow-delay="0.9s"> Em seguida acionar o botão "Pesquisar produtos".</li>
                                ...
                                <li class="wow fadeInRight"  data-wow-delay="0.6s"> Nessa "grade" marcar o quadrículo correspondente ao item que fará parte do inventário. Quando a seleção for realizada  somente por "palavra chave" aparecerá  vários itens  que possuam a palavra chave em sua especificação para que seja selecionado pelo respectivo quadrículo.</li>
                                <li class="wow fadeInRight"  data-wow-delay="0.9s"> Ao ser acionado o botão "Finalizar" o Siga/Sgbm retornará à janela "Abrir Inventário" incluído o item selecionado .</li>
                                ...
                                <li class="wow fadeInRight"  data-wow-delay="0.9s"> Clicando no botão "Pesquisar produtos" o Siga/Sgbm recomeça o procedimento do item 09 ao 13 acrescentando mais itens à grade "Produtos selecionados".</li>
                                ...
                                <!-- Imagem 284 - End --><br>
                                <p><strong>B.2) No Caso de Inventári Por Grupo</strong></p>

                                <li class="wow fadeInRight"  data-wow-delay="0.3s">No campo "Descrição" descrever o nome do inventário identificando o tipo de inventário e o mês e ano de realização.</li>
                                <li class="wow fadeInRight"  data-wow-delay="0.6s"> No campo "Tipo de Inventário" selecionar a opção  GRUPO, nessa opção o SIGA/SGBM habilitará o botão “Pesquisar produtos” para que sejam selecionados os itens específicos que fará  parte do inventário. </li>
                                <li class="wow fadeInRight"  data-wow-delay="0.9s">  No campo "Grupo" selecionar o grupo de materiais do Catálogo de Bens, Materiais e Serviços do qual será efetuado o inventário.</li>
                                <li class="wow fadeInRight"  data-wow-delay="1.3s">Acionar o botão "Criar inventário" para que o inventário seja inserido na "agenda de inventários".</li>
                                ...
                                <li class="wow fadeInRight"  data-wow-delay="1.3s">Na coluna "Ações" da referida grade são apresentados vários ícones que estará  sendo habilitados a medida que o inventário evolui na sua execução, o primeiro deles em formato de "Botão" ativa o inventário, ou seja, inicia a sua execução.</li>
                                <br><!-- Titulo Figura -->
                                <div class="text-center">
                            ...
                            <ol>
                                ...
                                <!-- Imagem 287 - End --><br>
                                <li class="wow fadeInRight"  data-wow-delay="0.3s">  Acionado o comando na barra de menu, o SIGA/SGBM demonstra o painel de controle "Gerenciar Inventários" no canto direito do painel é apresentada uma secção "Pessoas" .</li>
                                <br>
                                <!-- Titulo Figura -->
                                <div class="text-center">
                                ...
                                <li class="wow fadeInRight"  data-wow-delay="0.6s"> No campo "Tipo de Inventário" selecionar a opção  GRUPO, nessa opção o SIGA/SGBM habilitará o botão “Pesquisar produtos” para que sejam selecionados os itens específicos que fará  parte do inventário. </li>
                                <li class="wow fadeInRight"  data-wow-delay="0.9s">  No campo "Grupo" selecionar o grupo de materiais do Catálogo de Bens, Materiais e Serviços do qual será efetuado o inventário.</li>
                                <li class="wow fadeInRight"  data-wow-delay="0.9s">  No ícone em formato de "Lixeira" permite excluir a pessoa do cadastro de participantes de inventário.</li>
                                <br>
                                <!-- Titulo Figura -->
                                <div class="text-center">
                            ...
                            <ol>
                                ...
                                <br>
                                <p>Após clicar no botão “Criar Inventário”, (conforme passos 18 e 22 anteriores) seja qual for a modalidade de inventário, o SIGA/SGBM apresentará uma legenda associada ao Status e às Ações relativas ao inventário iniciado.</strong> </p>
                                <br>
                                <br><!-- Titulo Figura -->
                                <div class="text-center">
                                ...
                                <!-- Imagem 290 - End --><br>
                                <li class="wow fadeInRight"  data-wow-delay="0.3s"> O ícone em formato de "Botão" indica que o inventário foi criado, mas ainda não foi ativado e não foram atribuídas a estes as duas contagens iniciais do inventário. Para ativar o inventário, basta clicar neste ícone.</li>
                                <br>
                                <!-- Fique Atento -->
                                <div class="FiqueAtentoCaixa">
                                    <p class="FiqueAtentoTitulo"> Fique Atento</p>
                                    <div class="FiqueAtentoTexto">
                                        <p>Caso se faça necessário, por qualquer inconveniência a desativar  um determinado inventário, que já foi ativado, basta clicar novamente nesse ícone para reverter a situação do inventário.</p>
                                    </div>
                                </div>
                                <!-- Titulo Figura -->
                                <div class="text-center">
                                ...
                                <br>
                                <!-- Imagem 291 - End --><br>
                                <li class="wow fadeInRight"  data-wow-delay="0.3s">Ao clicar no ícone de ativarão todos os demais ícones ficarão habilitados e passarão a ficar coloridos. Isso indica que o inventário está em curso.</li>
                                <br>
                                <!-- Titulo Figura -->
                                <div class="text-center">
                                ...
                                <br> 
                                <li class="wow fadeInRight"  data-wow-delay="0.3s">O ícone em formato de "Pilha de Caixas" indica que inventário acabou de ser ativado e necessita que sejam atribuídas as equipes de inventário e registrado no sistema o resultado das contagens executadas. Enquanto as duas contagens estiverem sendo executadas o inventário permanecerá nesse Status. Clicando nesse ícone será  formadas as equipes de contagem.</li>   
                                <br>
                                <!-- Titulo Figura -->
                                <div class="text-center">
                                ...
                                <li class="wow fadeInRight"  data-wow-delay="0.3s">Clicando no ícone “Criar Equipe” poderá ser formada as equipes de contagem com as pessoas que foram previamente cadastradas no painel “Pessoas”, visto anteriormente.</li>
                                <br>
                                <!-- Titulo Figura -->
                                <div class="text-center">
                                ...
                                <li class="wow fadeInRight"  data-wow-delay="0.3s">No campo "Pessoas Disponíveis" escolha na relação de pessoas disponíveis, à esquerda da tela, clicando no quadrículo, àquelas que comporão a equipe de contagem que está sendo editada. </li>
                                <li class="wow fadeInRight"  data-wow-delay="0.3s">Em seguida clicar no botão “Seta” passando a pessoa selecionada no campo "Pessoas Disponíveis" para o campo "Pessoas Selecionadas".</li>
                                <li class="wow fadeInRight"  data-wow-delay="0.3s">No campo "Pessoas Selecionadas" clicar no quadrículo ao lado do nome da pessoa, em seguida clicar no botão “Salvar Equipe”.</li>
                                <br>
                                <!-- Fique Atento -->
                                <div class="FiqueAtentoCaixa">
                                    <p class="FiqueAtentoTitulo"> Fique Atento</p>
                                ...
                                <br>
                                <li class="wow fadeInRight"  data-wow-delay="0.3s"> Na coluna "Imprimir" clicar sobre o ícone de cor "laranja" para imprimir o relatório "Gabarito para contagem de inventário" , assim como o status da contagem passará de "Pendente" para "Aberta".</li>
                                <br>
                                <br>
                                <!-- Titulo Figura -->
                                <div class="text-center">
                                ...
                                <br>
                                <li class="wow fadeInRight"  data-wow-delay="0.3s">Acionado o ícone "Gabarito para contagem de inventário" o relatório será impresso em quantas vias se façam necessárias para distribuição entre os participantes da equipe de contagem. De posse do Relatório, no campo “Qtde” o participante escreverá o resultado da contagem que serão posteriormente digitadas no SIGA/SGBM.</li>
                                <br>
                                ...
                                <li class="wow fadeInRight"  data-wow-delay="0.6s">Em seguida clicar no botão “Finalizar Editar Dados”.</li>
                                <br>  
                                 <!-- Titulo Figura -->
                                 <div class="text-center">
                                ...
                                <br>
                                <li class="wow fadeInRight"  data-wow-delay="0.6s">Acionado o botão “OK” na janela "pop up", o SIGA/SGBM atualizará o "Status" da contagem de "Aberta" para "Fechada" e disponibilizar o "Resultado de Contagem de Inventário. A partir desse "Status" poderá ser iniciada a Contagem 2.</li>
                                <br> 
                                <!-- Titulo Figura -->
                                <div class="text-center">
                                ...
                                <br>
                                <li class="wow fadeInRight"  data-wow-delay="0.3s">Acionando o botão alterar poderá ser alterado o nome do coordenador da equipe.</li>
                                <li class="wow fadeInRight"  data-wow-delay="0.6s">No campo "Pessoas Disponíveis" escolha na relação de pessoas disponíveis, à esquerda da tela, clicando no quadrículo, àquelas que comporão a equipe de contagem que está sendo editada.</li>
                                <li class="wow fadeInRight"  data-wow-delay="0.9s">Em seguida clicar no botão “Seta” passando a pessoa selecionada no campo "Pessoas Disponíveis" para o campo "Pessoas Selecionadas".</li>
                                <li class="wow fadeInRight"  data-wow-delay="1.3s">No campo "Pessoas Selecionadas" clicar no quadrículo ao lado do nome da pessoa, em seguida clicar no botão “Salvar Equipe”.</li>
                                ...
                                <li class="wow fadeInRight"  data-wow-delay="0.6s"> Na coluna "Imprimir" clicar sobre o ícone de cor "laranja" para imprimir o relatório "Gabarito para contagem de inventário" , assim como o status da contagem passará de "Pendente" para "Aberta".</li>
                                <br>
                                <!-- Titulo Figura -->
                                <div class="text-center">
                                ...
                                <br>
                                <li class="wow fadeInRight"  data-wow-delay="1.3s">Acionado o botão “OK” na janela "pop up", o SIGA/SGBM atualizará o "Status" da contagem de "Aberta" para "Fechada" e disponibilizar o "Resultado de Contagem de Inventário. A partir desse "Status" poderá ser iniciada a verificação entre a Contagem 1 e a Contagem 2. </li>
                                <br>
                                <!-- Titulo Figura -->
                                <div class="text-center">
                                ...
                                <li class="wow fadeInRight"  data-wow-delay="0.6s">Acionar o botão “Ir para Verificação” para processar o confronto entre a Contagem 1 e a Contagem 2. </li>
                                <br>
                                <!-- Titulo Figura -->
                                <div class="text-center">
                                ...
                                <br>
                                <li class="wow fadeInRight"  data-wow-delay="0.3s">Acionado o ícone verde em formato de "três pontos seqüenciais", o Siga/Sgbm apresenta o detalhamento das contagens 1 e 2 para que seja analisada a razão dos conflitos.</li>
                                <li class="wow fadeInRight"  data-wow-delay="0.6s">Acionar o botão "Fechar visualização" para retornar somente à tela "Verificações".</li>
                                <br>
                                <!-- Titulo Figura -->
                                <div class="text-center">
                                ...
                                <br>
                                <li class="wow fadeInRight"  data-wow-delay="0.9s"> Acionar o botão "Voltar para Inventários" para iniciar o processo da Contagem 3 para dirimir as divergências entre contagens 1 e 2.</li>
                                <br>
                                <!-- Titulo Figura -->
                                <div class="text-center">
                                ...
                                <br>
                                <li class="wow fadeInRight"  data-wow-delay="0.3s">No campo "Pessoas Disponíveis" escolha na relação de pessoas disponíveis, à esquerda da tela, clicando no quadrículo, àquelas que comporão a equipe de contagem que está sendo editada. </li>
                                <li class="wow fadeInRight"  data-wow-delay="0.6s">Em seguida clicar no botão “Seta” passando a pessoa selecionada no campo "Pessoas Disponíveis" para o campo "Pessoas Selecionadas". </li>
                                <li class="wow fadeInRight"  data-wow-delay="0.9s">No campo "Pessoas Selecionadas" clicar no quadrículo ao lado do nome da pessoa, em seguida clicar no botão “Salvar Equipe”. </li>
                                ...
                                <li class="wow fadeInRight"  data-wow-delay="0.3s">Digitar no campo “Qtde Física.” a quantidade do item constante no “Relatário de Gabarito de Contagem de Inventário” que foi resultante da contagem em campo. </li>
                                <li class="wow fadeInRight"  data-wow-delay="0.6s">Em seguida clicar no botão “Finalizar Editar Dados”.</li>                                
                                <br>
                                <!-- Titulo Figura -->
                                <div class="text-center">
                                ...
                                <br>                                
                                <li class="wow fadeInRight"  data-wow-delay="0.3s">Estando a Contagem 1, Contagem 2e Contagem 3 com o status "Fechada" já é possível fazer a verificação por intermédio do SIGA/SGBM para apurar diferenças entre contagens.</li> 
                                <li class="wow fadeInRight"  data-wow-delay="0.6s"> Acionar o botão “Ir para Verificação” para processar o confronto entre a Contagem 1 e a Contagem 2.</li> 
                                <br>
                                <!-- Titulo Figura -->
                                <div class="text-center">
                                ...
                                <br>                                
                                <li class="wow fadeInRight"  data-wow-delay="0.9s">Ao acionar o botão "Ir para Verificação" o Siga/Sgbm apresentará a janela "Verificações" com a grade especificando a "Verificação2" em evidência cujo Status e o Resultado apresentam o valor "não Processado".</li> 
                                <li class="wow fadeInRight"  data-wow-delay="1.3s">Acionar o ícone azul em formato de “Engrenagens” para processar a verificação entre a Contagem 1, Contagem 2 e Contagem 3.</li>
                                <br>
                                <!-- Titulo Figura -->
                                <div class="text-center">
                                ...
                                <li class="wow fadeInRight"  data-wow-delay="0.9s"> No campo “Justificativa” para ajuste", quando houver, descrever a justificativa do acerto que será realizado no registro escritural.</li> 
                                <li class="wow fadeInRight"  data-wow-delay="1.3s">Ao acionar o botão "Finalizar inventário" o sistema ajustará o saldo (Qtde no sistema) considerando a quantidade resultante das contagens física.</li>
                                <br>
                                <!-- Titulo Figura -->
                                <div class="text-center">
                                ...
                                <li class="wow fadeInRight"  data-wow-delay="0.6s">Ao acionar o botão "Relatório" será emitido o relatório para documentação do resultado final do inventário.</li>
                                <br>
                                <!-- Titulo Figura -->
                                <div class="text-center">
