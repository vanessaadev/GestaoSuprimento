                ...
                <div class="row"> <!-- Begin row -->
                    ...
                    <div class="col-md-10"> <!-- Begin col-md-10 -->
                        <div class="page-title">
                            ...
                            <p>No módulo I, na aula 04, deste curso, dedicamos o item 4.6 exclusivamente para discutir os procedimentos de recebimento de material que se aplica tanto aos materiais de consumo como os materiais permanentes. Recapitulando àquela ocasião, podemos concluir que o recebimento é o ato pelo qual a equipe do almoxarifado recebe do fornecedor os materiais de consumo e bens móveis adquiridos pelo órgão/entidade, efetuando as conferências necessárias para dar o aceite dos produtos. Esses materiais e bens devem ser entregues pelo fornecedor em local previamente determinado no contrato e conforme agendamento realizado junto ao almoxarifado. O recebimento pode ser subdividido em duas etapas: provisório e definitivo.</p>
                            ...
                            <ol class="1">
                                ...
                                <br><li class=" wow fadeInRight" data-wow-delay="0.6s"> <strong>Recebimento Definitivo:</strong> ato por meio do qual se declara, na documentação fiscal, que o material recebido está de acordo com as especificações do contrato.
                                    <br><br>Deverão ser efetuadas três conferências pela equipe do almoxarifado no ato do recebimento de materiais e bens que são: Conferência visual, Conferência quantitativa, Conferência qualitativa.     </li><br>
                                ...
                                <br><li class=" wow fadeInRight" data-wow-delay="1.0s"> <strong>Conferência Quantitativa:</strong> verificação se a quantidade declarada pelo fornecedor na nota fiscal corresponde efetivamente à quantidade física que está sendo recebida.</li>
                                <br><li class=" wow fadeInRight" data-wow-delay="1.3s"> <strong>Conferência Qualitativa:</strong> análise de qualidade efetuada por meio da confrontação das condições contratadas na Ordem de Compra/Contrato com as consignadas na Nota Fiscal pelo fornecedor. Essa análise visa garantir o recebimento adequado do material contratado por meio do exame de suas características dimensionais, específicas e restrições de especificação. 
                                    <br><br>Após a conferência dos materiais e bens recebidos no almoxarifado, o almoxarife/servidor ou comissão poderá realizar a recusa total, o recebimento total ou parcial.  </li><br>
                                <li class=" wow fadeInRight" data-wow-delay="1.6s"> <strong>Recusa Total:</strong> consiste na situação em que a carga é recusada pelo almoxarife/servidor compreendendo as seguintes possibilidades:
                                    ...
                                    <span class=" wow fadeInRight" data-wow-delay="2.4s">Nos casos da recusa total há a possibilidade de novo agendamento para entrega.</span></li>
                                <br><li class=" wow fadeInRight" data-wow-delay="2.6s"> <strong> Recebimento Total:</strong> corresponde à situação em que o fornecedor efetua a entrega corretamente, atendendo todos os requisitos de documentação, quantidade e qualidade dos itens; caso em que o recebimento é finalizado.</li>
                                <br><li class=" wow fadeInRight" data-wow-delay="2.9s"> <strong> Recebimento Parcial:</strong> consiste no aceite da parte “correta” dos itens, nesse caso o fornecedor emitirá uma nova nota fiscal referente à quantidade “correta” cancelando a nota fiscal anterior. A mercadoria ficará separada aguardando a correção para poder dar entrada em estoque.
                                    ...
                                    <br><br>O Almoxarife terá duas opções de registro de entrada do material e bens móveis no sistema SIGA/SGBM: </li><br>
                            ...
                            <br>
                            <ol class="none">
                                <li class="wow fadeInLeft" data-wow-delay="0.3s">3.1) Recebimento por Ordem de Compra,  </li>
                                <li class="wow fadeInLeft" data-wow-delay="0.6s">3.2) Recebimento por Nota Fiscal, </li>
                                <li class="wow fadeInLeft" data-wow-delay="0.9s">3.3) Consulta de Notas Fiscais Salvas, </li>
                                <li class="wow fadeInLeft" data-wow-delay="1.3s">3.4) Conferência das Entradas, </li>
                                <li class="wow fadeInLeft" data-wow-delay="1.6s">3.5) Solicitação de Cancelamento de Nota Fiscal, </li>
                                <li class="wow fadeInLeft" data-wow-delay="1.9s">3.6) Autorização de Cancelamento de Nota Fiscal, </li>
                                <li class="wow fadeInLeft" data-wow-delay="2.3s">3.7) Cadastramento de Item de Material Permanente, </li>
                                <li class="wow fadeInLeft" data-wow-delay="2.6s">3.8) Alterar Classificação de Material.</li>
                            </ol>
