                ...
                <div class="col-md-10">
                    ...
                    <ul class="none ">
                        <li class="img-fluid wow fadeInLeft" data-wow-delay="0.3s"><i></i>
                            <h4>
                                Olá! <?php echo $NomeUsuario ?>, Bem-vindo(a) ao módulo 01 do curso <strong> Gestão de Suprimentos</strong>! Esperamos que o conteúdo proposto contribua para aprimorar o seu conhecimento acerca do tema. Bons estudos!
                            </h4>
                        </li>
                    </ul>
