                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            ...
                            <ol type="a" class="Texto">
                                <li class="wow fadeInDown" data-wow-delay="0.3s"> Abrangência – A classificação deve tratar de uma gama de características dos materiais em vez de reunir apenas materiais para serem classificados sob uma única ótica. Características como:</li>

                                <ul class="none">
                                    <li class="wow fadeInDown" data-wow-delay="0.6s" ><i class="fa fa-arrow-right CorVerdeClaroEstado"></i> Tamanho (comprimento, largura e altura);</li>
                                    <li class="wow fadeInDown" data-wow-delay="0.9s" data-wow-delay="0.6s"><i class="fa fa-arrow-right CorVerdeClaroEstado"></i> Densidade e Peso (por unidade ou volume);</li>
                                    <li class="wow fadeInDown" data-wow-delay="1.3s" data-wow-delay="0.9s"><i class="fa fa-arrow-right CorVerdeClaroEstado"></i> Forma (achatada, curva, compacta);</li>
                                    <li class="wow fadeInDown" data-wow-delay="1.6s" data-wow-delay="1.3s"><i class="fa fa-arrow-right CorVerdeClaroEstado"></i> Risco de danos (frágil, explosivo, contaminável, tóxico, corrosivo);</li>
                                    <li class="wow fadeInDown" data-wow-delay="1.9s" data-wow-delay="1.6s"><i class="fa fa-arrow-right CorVerdeClaroEstado"></i> Condição (Instável, pegajoso, úmido, perecível);</li>
                                    <li class="wow fadeInDown" data-wow-delay="2.3s" data-wow-delay="1.9s"><i class="fa fa-arrow-right CorVerdeClaroEstado"></i> Quantidade (relativa a intensidade de uso ou ao volume, no total e em tamanho de remessa ou por lote);</li>
                                    <li class="wow fadeInDown" data-wow-delay="2.6s" data-wow-delay="2.3s"><i class="fa fa-arrow-right CorVerdeClaroEstado"></i> Cronometria (regularidade, urgência,sazonal);</li>
                                    <li class="wow fadeInDown" data-wow-delay="2.9s" data-wow-delay="2.6s"><i class="fa fa-arrow-right CorVerdeClaroEstado"></i> Medidas Especiais (regulamentações, padrões internos da organização, critérios de operação).</li>
                                </ul>

                                <li class="wow fadeInDown" data-wow-delay="3.3s"> Flexibilidade: deve permitir interfaces entre os diversos tipos de classificação, de modo que se obtenha ampla visão do gerenciamento de estoques; em termos frequência de aquisição, quantidade em estoque, armazenagem, custo, assim como durabilidade no caso dos materiais permanentes.</li>

                                <li class="wow fadeInDown" data-wow-delay="3.6s"> Praticidade: a classificação deve ser direta e simples atendendo os requerimentos que são efetivamente importantes para a gestão dos estoques na modalidade de operação da organização.</li>
                            </ol>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-4">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <p class="FonteFigura"><strong>Figura 01 </strong></p>
                                        </div>
