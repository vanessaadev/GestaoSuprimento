                ...
                <div class="row"> <!-- Begin row -->
                    ...
                    <div class="col-md-10"> <!-- Begin col-md-10 -->
                        <div class="page-title">
                            ...
                            <h2 class="Titulo"> Distribuição de BENS Novos NO SIGA/SGBM</h2>
                            <hr>
                            ...
                            <ol>
                                <li class="wow fadeInLeft" data-wow-delay="0.3s">No campo Observação preencher com a informação que considerar importante para o atendimento da requisição, esse é um campo opcional. </li>
                                <li class="wow fadeInLeft" data-wow-delay="0.6s">Selecionar qual a modalidade que deseja efetuar a pesquisa do material para requisição se por Código ou Palavra Chave. </li>
                                <li class="wow fadeInLeft" data-wow-delay="0.9s">No campo editável logo abaixo da seleção informar o Código ou a Palavra Chave para a pesquisa do material. </li>
                                <li class="wow fadeInLeft" data-wow-delay="1.3s"> Acionar o botão Pesquisar para comandar a busca no SIGA/SGBM. </li>
                                ...
                                <li class="wow fadeInLeft" data-wow-delay="1.6s">Observar no campo Situação o ícone indicador de existência ou não de saldo de estoque do material solicitado, se for VERMELHO o item não possui estoque e portanto a requisição não poderá ser atendida, se for VERDE o item tem estoque e pode ser requisitado. </li>

                                <li class="wow fadeInLeft" data-wow-delay="1.9s">Marcar o quadrículo correspondente ao item a ser requisitado (somente poderão ser marcados os itens cujo ícone for verde. Caso contrário o SIGA/SGBM não permitirá a requisição.</li>
                                <li class="wow fadeInLeft" data-wow-delay="2.3s">No campo “Quantidade” informar a quantidade a ser solicitada do item marcado no campo 6 anterior, observar que para efeito de precisão de cálculo devem ser utilizadas quatro casas decimais. </li>
                                <li class="wow fadeInLeft" data-wow-delay="2.6s">Acionar o botão Adicionar para confirmar a quantidade requisitada para esse item especificamente. 
                            ...
                            <li class="wow fadeInLeft" data-wow-delay="0.9s">Acionando o botão Salvar é encerrado o modo de edição da requisição e essa é gravada no SIGA/SGBM e passa a compor a Agenda de Requisições a serem atendidas pelo perfil Almoxarife ou Almoxarife/Gestor Patrimonial. </li>
                            ...
                            <!-- Imagem 173 - End --><br>
                            <p>As requisições salvas podem ser consultadas, alteradas e excluídas através do menu <strong>Consultas > Almoxarifado > Requisições.</strong> </p>
