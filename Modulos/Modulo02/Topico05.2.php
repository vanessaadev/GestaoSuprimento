                ...
                <div class="row"> <!-- Begin row -->
                    ...
                    <div class="col-md-10"> <!-- Begin col-md-10 -->
                        <div class="page-title">
                            ...
                            <hr>
                            <p>O SIGA/SGBM permite registrar recebimento de doação assim como proceder a doações de materiais de consumo para isso o "perfil Almoxarife" deverá acionar na barra de menu o comando "Movimentos, Almoxarifado, Doação".</p>
                            <br>
                            <ol>
                                <!-- Titulo Figura -->
                                ...
                                <!-- Fim Titulo Figura -->
                                <br>
                                <li class="wow fadeInLeft" data-wow-delay="0.3s">Uma vez que a opção selecionada no campo anterior foi "Receber de", informar no campo "Origem" o nome do órgão ou entidade de onde se originou a doação do material em questão.</li>
                                <li class="wow fadeInLeft" data-wow-delay="0.6s">No campo "Nº Termo Doação" informar o número do Termo de Doação ou documento similar que formaliza a operação</li>
                                <li class="wow fadeInLeft" data-wow-delay="0.9s"> O campo "Data Doação" informar a data de registro da operação no SIGA/SGBM.</li>
                                <li class="wow fadeInLeft" data-wow-delay="1.3s">No campo "Observação" descrever qualquer informação que se faça necessária para justificar a operação de recebimento da doação do material.</li>
                                <br>
                                <!-- Titulo Figura -->
                                <div class="text-center">
                                ...
                                <!-- Fim Titulo Figura -->
                                <br>
                                <li class="wow fadeInLeft" data-wow-delay="0.3s">Selecionar a forma que desejar fazer a pesquisa no SIGA/SGBM do material a ser doado se por "Código" ou "Palavra Chave".</li>
                                <li class="wow fadeInLeft" data-wow-delay="0.6s">Na "caixa de texto" abaixo do campo de seleção informar o código ou a palavra chave para a pesquisa do material.</li>

                                <li class="wow fadeInLeft" data-wow-delay="0.9s">Acionar o botão "Pesquisar" para efetuar a pesquisa do item informado (código ou palavra-chave).</li>
                                <br>
                                <!-- Fique Atento -->
                                ...
                                <li class="wow fadeInLeft" data-wow-delay="0.6s">No campo "Quantidade" informar a quantidade a ser recebida como doação, utilizando quatro casas decimais.</li>
                                <li class="wow fadeInLeft" data-wow-delay="0.9s"> No campo "Valor", informar o "Valor Unitário" do material recebido em doação.</li>
                                <li class="wow fadeInLeft" data-wow-delay="1.3s"> Acionar o Botão "Adicionar" , caso se tratar da doação de um único item, no caso de ser mais de um item recebido em doação, acionar o botão "Adicionar e continuar" para que sejam selecionados outros itens que compõem o recebimento de doação.</li>
                                <br>
                                <br>
                                <!-- Titulo Figura -->
                                <div class="text-center">
