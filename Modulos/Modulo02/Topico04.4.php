                ...
                <div class="row"> <!-- Begin row -->
                    ...
                    <div class="col-md-10"> <!-- Begin col-md-10 -->
                        <div class="page-title">
                            ...
                            <hr>
                            <br>
                            <p>O SIGA/SGBM permite registrar devoluções decorrentes de materiais requisitados e não consumidos para isto o "perfil Almoxarife" deverá acionar na barra de menu o comando <strong></strong> "Movimentos, Almoxarifado, Devolução".</p>                                                        
                            <br>                                                                                           
                            <br><!-- Titulo Figura -->
