                ...
                <div class="row"> <!-- Begin row -->
                    ...
                    <div class="col-md-10"> <!-- Begin col-md-10 -->
                        <div class="page-title">
                            ...
                            <!-- Sub Título -->
                            <p class="SubTitulo"> Requisição de Bem Móvel</p>
                            <hr>
                            <br>
                            ...
                            <p>Dessa forma a requisição de bem móvel será efetuada no Siga/Sgbm pelo "Perfil Requisitante" da mesma forma com que ocorre a requisição de material de consumo. Para efetuar uma requisição de bem móvel acionar na barra de menu do Siga/Sgbm o comando <strong>"Movimentos, Patrimônio, Requisição Bem" conforme foi demonstrado a seguir:</strong> </p>
                            ...
                            <ol>
                                ...
                                <p>Uma vez acionado o botão "Pesquisar" o SIGA SGBM apresentará um janela "Pop up" com o resultado da pesquisa demonstrando uma grade com as informações básicas de requisição do material, inclusive a "Situação" de estoque.</p>
