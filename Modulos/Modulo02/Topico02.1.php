                                ...
                                <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="Item03" data-bs-parent="#AccordionFase01">
                                    <div class="accordion-body">
                                        ...
                                        <ol class="none">
                                            ...
                                            <br>
                                            <li>8 - Ao acionar o botão "Salvar" o SIGA/SGBM apresentará uma janela de confirmação da operação que poderá ser cancelada ou confirmada.</li>
                                ...
                                <div id="flush-collapseFour" class="accordion-collapse collapse" aria-labelledby="Item04" data-bs-parent="#AccordionFase01">
                                    <div class="accordion-body">
                                        ...
                                        <p>Já os itens específicos são àqueles adquiridos individualmente pelo órgão/entidade e podem ou não ter codificação no Catálogo de Bens, Materiais e Serviços. Nesses casos a identificação do item no referido Catálogo se dará por intermédio da sua especificação de maneira que as características demonstradas na especificação correspondam é características físicas do item. Dessa forma o cadastramento do item será feito por intermédio da "Descrição".
                                            <br><br>Quando não for identificada nenhuma especificação que corresponda é características do item, o mesmo deve ser incluído no Catálogo por intermédio da funcionalidade "Solicitação Catálogo".
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div id="flush-collapseFive" class="accordion-collapse collapse" aria-labelledby="Item05" data-bs-parent="#AccordionFase01">
                                    <div class="accordion-body">
                                        <ol>
                                            ...
                                            <!-- Imagem 20 - End -->
                                            <br>
                                            <p>Na tela Cadastro de Material deverão ser informados os seguintes campos:</p>
