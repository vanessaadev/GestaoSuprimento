                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer text-center">
                                            <p class="TituloFigura"><strong>Fonte: </strong></p>
                                        </div>
                                    </div>
                            ...
                            <div class="text-center">
                                ...
                                <p class="FonteFigura"><strong>Figura 13: </strong>  Estoques de canal (de distribuição)</p>
                            </div>
                            ...
                            <div class="text-center">
                                ...
                                <p class="FonteFigura"><strong>Figura 23: </strong>  Demanda permanente</p>
                            </div>
                            ...
                            <div class="text-center">
                                ...
                                <p class="FonteFigura"><strong>Figura 24: </strong>  Demanda sazonal</p>
                            </div>
                            ...
                            <div class="text-center">
                                ...
                                <p class="FonteFigura"><strong>Figura 25: </strong>  Demanda irregular</p>
                            </div>
                            ...
                            <div class="text-center">
                                <a href="imagens/Figura26.png" data-bs-toggle="modal" data-bs-target="#Imagem26">
                                    <img class="img-fluid wow fadeInLeft" src="imagens/Figura26.png" alt="Alt da imagem fica aqui">
                                </a>
                                <p class="FonteFigura"><strong>Figura 26: </strong> Demanda em declínio</p>
                            </div>
                            ...
                            <div class="text-center">
                                <a href="imagens/Figura27.png" data-bs-toggle="modal" data-bs-target="#Imagem27">
                                    <img class="img-fluid wow fadeInLeft" src="imagens/Figura27.png" alt="Alt da imagem fica aqui">
                                </a>
                                <p class="FonteFigura"><strong>Figura 27: </strong> Demanda em declínio</p>
                            </div>
                            ...
                            <!-- Titulo Figura -->
                            <div class="text-center">
                                <a href="imagens/Figura28.png" data-bs-toggle="modal" data-bs-target="#Image28">
                                    <img class="img-fluid wow fadeInLeft" src="imagens/Figura28.png" alt="Alt da imagem fica aqui">
                                </a>
                                <p class="FonteFigura"><strong>Figura 28: </strong> Demanda derivada</p>
                            </div>
                            ...
                            <div class="text-center">
                                ...
                                <p class="FonteFigura"><strong>Figura 29: </strong>  Rotatividade Dos Estoques</p>
                            </div>
                            ...
                            <div class="text-center">
                                ...
                                <p class="FonteFigura"><strong>Figura 31: </strong> Ressuprimento Dos Estoques</p>
                            </div>
                            ...
                            <div class="text-center">
                                ...
                                <p class="FonteFigura"><strong>Figura 33: </strong>  sistema de controle</p>
                            </div>
                            ...
                            <div class="text-center">
                                <a href="imagens/Figura35.png" data-bs-toggle="modal" data-bs-target="#Imagem35">
                                    <img class="img-fluid wow fadeInRight" data-wow-delay="0.5s" width="200" class="img-fluid" src="imagens/Figura35.png" alt="Alt da imagem fica aqui">
                                    <p class="TituloFigura"><strong>Figura 35: </strong>Nome da Figura Aqui</p>
                                </a>
                            </div>
                            <!-- Imagem 35 - MODAL -->
                            ...
                            <div class="text-center">
                                ...
                                <p class="FonteFigura"><strong>Figura 37: </strong> Recebimento Definitivo</p>
                            </div>
